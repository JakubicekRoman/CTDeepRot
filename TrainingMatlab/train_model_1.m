...
InLayer = imageInputLayer([224 224 9],'Name','imageinput','Normalization','zerocenter','DataAugmentation','randcrop');
...
pathL = 'C:\Data\Jakubicek\CTDeepRot_data\training\labels_mat';
...
pathL = 'C:\Data\Jakubicek\CTDeepRot_data\testing\labels_mat';
